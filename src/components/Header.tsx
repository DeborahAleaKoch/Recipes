	...
	return (
		<div className=''>
			...
			<div className='w-screen'>
				<div className=' bg-[url(./../public/img/Banner.svg)] object-cover bg-no-repeat bg-cover text-4xl text-white text-center h-60 text-balance pt-11 leading-13 w-screen'>
